...
--
-- Name: Employees_Schema; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA "Employees_Schema";


ALTER SCHEMA "Employees_Schema" OWNER TO postgres;
...
CREATE TABLE public.departments (
    dept_no character varying(200) NOT NULL,
...
CREATE TABLE public.employees (
    emp_no integer NOT NULL,
    emp_title character varying(200) NOT NULL,
...
CREATE TABLE public.titles (
    title_id character varying(200) NOT NULL,
